...
function create_post_type() {
    ...
    register_post_type( 'projects',
        array( 'labels' => array( 'name' => __( 'Project' ),
        'singular_name' => __( 'Project' ) ),
        'public' => true,
        'has_archive' => false,
        'rewrite' => array( 'slug' => 'project' ),
        'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'page-attributes', 'post-formats', 'custom-fields'),
        'taxonomies' => array( '' ), )
    );
}
...
{
    $labels = array(
        'name'                       => _x('Project Category', 'Taxonomy General Name', 'text_domain'),
